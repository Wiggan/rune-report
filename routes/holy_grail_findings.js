...
router.post('/', function (req, res, next) {
    try {
        ...
        const { player_name, player_password, holy_grail_item_name } = req.fields;
        ...
        console.log("Inserting new holy grail item finding for player_id:" + JSON.stringify(player_id) + ", item id:" + JSON.stringify(holy_grail_item_id));
        const result = db.instance.prepare(`INSERT INTO holy_grail_item_finding (player_id, holy_grail_item_id, finding_date, finding_location) VALUES (?, ?, '2020-01-01 10:00:00', '')`).run(player_id.player_id, holy_grail_item_id.holy_grail_item_id);
        if (result.changes) {
